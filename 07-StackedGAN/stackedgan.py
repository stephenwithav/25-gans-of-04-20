...
from tensorflow.keras.layers import Activation, Dense, Input, LeakyReLU
...
def build_generator(latent_codes, image_size, feature1_dim=256):
    ...
    gen0 = generator_aux(feature1, image_size, codes=z0)

    return gen0, gen1


def discriminator_aux(inputs,
                  activation='sigmoid',
                  num_labels=None,
                  num_codes=None):
...
def build_and_train_models():
    ...
    dis0 = discriminator_aux(inputs, num_codes=z_dim)
...
(enc0, enc1, gen0, gen1, dis0, dis1, adv0, adv1) = build_and_train_models()
